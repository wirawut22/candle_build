...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"แรกสุด",sLast:"ล่าสุด",sNext:"ถัดไป",sPrevious:"ก่อนหน้า"},sEmptyTable:"No data available in table",sInfo:"แสดง _เริ่มต้น_ ถึง _สิ้นสุด_ ของ _รวม_ รายการ",sInfoEmpty:"แสดง 0 ถึง 0 ของ 0 รายการ",
